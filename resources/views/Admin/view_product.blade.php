      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <div class="">
              <form class="searchbox" action="{{route('search')}}" method="get">
        ...
        <table class="table table-sm px-2 py-2">
          <thead>
            <tr>
              ...
              <th class="" scope="col">Catergory</th>
          ...
          <tbody>
              ...
              <td> $ {{ $product->price }}</td>
              <td class = "text-center"><img src="/products_images/{{ $product->image }}" alt="" class="img"></td>
              <td>{{ $product->status == 1 ? 'Vissible' : 'Hidden' }}</td>
              <td class="text-center"><a href="{{ route('updateProduct', $product->slug) }}" class="btn btn-warning"> <i class="fa fa-pencil mr-4 ml-4"></i> </a></td>
              <td class="text-center"><a href="{{ route('productDelete', $product->id) }}" onclick="confirmation(event)" class = "btn btn-danger "> <i class="fa fa-trash mr-4 ml-4"></i> </a></td>
              </tr>
              @endforeach
