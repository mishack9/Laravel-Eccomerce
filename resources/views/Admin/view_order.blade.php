      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            ...
            <div class="">
              <form class="searchbox" action="{{route('searchOrder')}}" method="get">
       ...
       <div class="table-responsive mb-5">
        <table class="table table-sm px-2 py-2">
          ...
          <tbody>
              ...
              <td><a href="{{route('printpdf', $data->id)}}" class = "btn btn-secondary"><i class="fa fa-download"></i></a></td>
              <td class="text-center"><a href="{{ route('deliverorder', $data->id) }}"  class="btn btn-info"> Deliver </a></td>
              <td class="text-center"><a href="{{ route('inprogress', $data->id) }}"  class="btn btn-warning"> Hold_on </a></td>
            </tr>
              @endforeach
