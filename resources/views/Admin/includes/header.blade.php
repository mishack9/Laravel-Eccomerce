    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <div class="right-menu list-inline no-margin-bottom">    
          ...
          <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1" style="width:15px;">5</span></a>
          ...
          <div class="list-inline-item dropdown">
            ...
            class="nav-link tasks-toggle"><i class="icon-settings"></i>{{-- <span class="badge dashbg-3">9</span> --}}
          </a>
            <div aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu tasks-list"><a href="#" class="dropdown-item">
                <div class="text d-flex justify-content-between"><strong> Profile </strong><span>40% complete</span></div>
                <div class="progress">
        ...
        {{--   <div class="list-inline-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="nav-link">Mega <i class="fa fa-ellipsis-v"></i></a>
          ...
          <!-- Languages dropdown    -->
          <div class="list-inline-item dropdown">
            <a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><span class="d-none d-sm-inline-block">Language</span></a>
            <div aria-labelledby="languages" class="dropdown-menu">
            <a rel="nofollow" href="{{url('/setlang/en')}}" class="dropdown-item"> {{-- <img src="{{ asset('admincss/img/flags/16/DE.png') }}" alt="English" class="mr-2"> --}}<span>English  </span></a>
            <a rel="nofollow" href="{{url('/setlang/hausa')}}" class="dropdown-item"> {{-- <img src="img/flags/16/FR.png" alt="English" class="mr-2"> --}}<span>Hausa  </span></a>
          </div>
          </div>
          <!-- Log out               -->
          <div class="list-inline-item logout">  
                          <form action="{{ route('logout') }}" method = "POST">
                            @csrf
                            <button>Logout<i class="icon-logout"></i></button>
                          </form> </a></div>
        </div>
      </div>
    </nav>
